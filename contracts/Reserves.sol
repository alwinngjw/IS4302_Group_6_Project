...
contract Reserves {
    ...
    //To simulate that our reserves already have USDC tokens, trigger this function to send 1000 USDC tokens to the reserves
    ...
    //Let owner withdraw specific amount in USDC tokens
    function withdrawUSDC(uint256 amount) public ownerOnly returns (uint256) {
        require(usdcToken.balanceOf(address(this)) >= amount, "Please ensure total USDC Reserve has enough amount!");
    ...
    //DELEET THIS
     function sendEtherToLP(uint256 amount, address addressToSend) public payable {
